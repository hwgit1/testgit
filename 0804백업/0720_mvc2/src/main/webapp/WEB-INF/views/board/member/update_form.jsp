		...
		<table class="table table-hover">
			<tbody>
				<tr>
					<th>제 목</th>
					<td>
						<input type="text" id="title" name="title" maxlength="20" class="form-control" value="${detail_dto.title}">
				...
				<tr>
					<th>내 용</th>
					<td>
						<textarea class="form-control" id="contents" name="contents">${detail_dto.contents}</textarea>
