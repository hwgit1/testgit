...
public class DongCodeController {
	...
	public String dongSearch() {
		return "test/dong_search";//jsp 파일 이름
	}//dongSearch
	...
	public void sidoSelect(PrintWriter out) {
		...
		Gson gson = new Gson();
		String jsonString = gson.toJson(list);//out.print(new Gson().toJson(list)); -> out.print까지 한 줄로 표현 가능
	...
	public String dongCodeView() {
		return "/test/dong_code";//jsp 파일 이름
	}//dongCodeView
}//class
